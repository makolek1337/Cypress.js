describe('Автотест формы авторизации', function () {
   ...
   it('Неправильный логин', function () {
        cy.visit('https://login.qa.studio/');
        cy.get('#mail').type('ge2rman@dolnikov.ru');
        cy.get('#pass').type('iLoveqastudio1');
        cy.get('#loginButton').click();
        cy.get('#messageHeader').should('be.visible');
        cy.get('#messageHeader').contains('Такого логина или пароля нет');
   ...
   it('e2e тест на покупку нового аватара для тренера', function () {
        ...
        cy.get(':nth-child(1) > .auth__input').type('makolek163rus@gmail.com');
        cy.get('#password').type('Makolek1337');
